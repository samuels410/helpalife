(function (d, c, a, e) {
    ...
    b.prototype = {defaults: {navItems: "a", currentClass: "current", changeHash: false, easing: "swing", filter: "", scrollSpeed: 850, scrollThreshold: 0.5, begin: false, end: false, scrollChange: false}, init: function () {
        ...
        d("html, body").animate({scrollTop: g-98}, this.config.scrollSpeed, this.config.easing, h)
