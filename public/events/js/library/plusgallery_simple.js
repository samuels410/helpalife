          ...
          if(albumTotal > 0 ) {
            jQuery.each(objPath,function(i,obj){
              ...
              if(i < albumTotal){
                ...
                galleryImage = 'https://farm' + obj.farm + '../../.staticflickr.com/default.htm' + obj.server + '/' + obj.primary + '_' + obj.secret + '../../_n.jpg';
      ...
      parseData: function(json,title,pg_type,obj_click,data_limit){
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            case 'flickr':
              imgTitle = obj.title;
              imgSrc = 'http://farm' + obj.farm + '../../.staticflickr.com/default.htm' + obj.server + '/' + obj.id + '_' + obj.secret + flickrImgExt + '.jpg';
              imgTh = 'http://farm' + obj.farm + '../../.staticflickr.com/default.htm' + obj.server + '/' + obj.id + '_' + obj.secret + '../../_z.jpg';
